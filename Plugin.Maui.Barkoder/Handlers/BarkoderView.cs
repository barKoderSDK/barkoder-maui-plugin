...
, 0.0);
   ...
   , false);
    ...
    public static BindableProperty ARContinueScanningOnLimitProperty = BindableProperty.Create(nameof(ARContinueScanningOnLimit)
   , typeof(bool)
   , typeof(BarkoderView)
   , false);

    public static BindableProperty AREmitResultsAtSessionEndOnlyProperty = BindableProperty.Create(nameof(AREmitResultsAtSessionEndOnly)
, typeof(bool)
, typeof(BarkoderView)
, false);
...
, BarkoderAROverlayRefresh.NORMAL);
  ...
  , false);
    ...
    public static BindableProperty ARResultLimitProperty = BindableProperty.Create(nameof(ARResultLimit)
   , typeof(int)
   , typeof(BarkoderView)
   , 0);
...
, false);
   ...
   BindableProperty.Create(nameof(IsIdDocumentMasterChecksumEnabled), typeof(bool), typeof(BarkoderView), false);
    ...
    {
        get => (bool)GetValue(ARContinueScanningOnLimitProperty);
        set
        {
            SetValue(ARContinueScanningOnLimitProperty, value);
            Handler?.Invoke(nameof(BarkoderView.SetARContinueScanningOnLimitRequested), value);
        }
    }

    public bool AREmitResultsAtSessionEndOnly
    {
        get => (bool)GetValue(AREmitResultsAtSessionEndOnlyProperty);
        set
        {
            SetValue(AREmitResultsAtSessionEndOnlyProperty, value);
            Handler?.Invoke(nameof(BarkoderView.SetAREmitResultsAtSessionEndOnlyRequested), value);
        }
    }
...
public bool UpcEanDeblurEnabled
    ...
    {
        get => (int)GetValue(ARResultLimitProperty);
        set
        {
            SetValue(ARResultLimitProperty, value);
            Handler?.Invoke(nameof(BarkoderView.SetARResultLimitRequested), value);
        }
    }
    ...
    {
        Handler?.Invoke(nameof(BarkoderView.CaptureImageRequested));
    }
