...
@property (nonatomic, readonly, copy) NSString * _Nonnull libVersion;
...
- (UIImage * _Nullable)sadlImageFromExtra:(NSDictionary * _Nonnull)extra SWIFT_WARN_UNUSED_RESULT;
...
+ (void)setCustomOptionGlobalWithOption:(NSString * _Nonnull)option value:(int32_t)value;
...
- (NSDictionary<NSString *, NSString *> * _Nonnull)getLicenseInfo SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, copy) NSArray<NSArray<NSValue *> *> * _Nonnull locations;
@property (nonatomic, copy) NSString * _Nonnull imageInBase64;
@property (nonatomic, copy) NSString * _Nonnull mainImageInBase64;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull binaryDataAsBase64;
